...
Applic silicon version). Once installed, leave the app open/running. 
Docker desktop is freely available from the following site:
...
If the build takes more than a few minutes, ctrl-C to exit the build 
